...
class Spoofed:
    ...
    report_list_of_org = {"code": 0, "data": {"count": 0, "report_list": []}}

    # /client/1/org/all-junior-partner-list
    all_junior_partner_list = {"code": 0, "data": {"org_list": []}}

    # /client/1/stat/brand/item-stat
    item_stat = {"code": 0, "data": {"brand": 0, "item": 0}}
    ...
    item_sales = {
        ...
        "data": {
            "list": {
                "data": {"2023/08/13": 0, "2023/08/14": 0, "2023/08/15": 0},
                "total": 0,
            }
        },
    }
    ...
    assembler_stat = {"code": 0, "data": {"stat": {}}}

    # /client/1/object-record/list-for-brand
    list_for_brand = {"code": 0, "data": {"count": 0, "record_list": []}}
